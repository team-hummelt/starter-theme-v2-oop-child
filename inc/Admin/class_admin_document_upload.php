...
class Admin_Document_Upload
{
     ...
     * @return static
     */
    public static function instance(Register_Child_Hooks $main ): self
    {
    ...
    public function __construct(Register_Child_Hooks $main)
    {
        ...
        $settings = get_option('child_upload_settings');
        ...
        $this->options = [
            ...
            'check_type' => false,
            'mkdir_mode' => 0755,
            'max_file_size' =>10 * 1024 * 1024, // MB
            'accept_file_types' => '/\.(pdf|svg|rar|zip|jpg||jpeg|png|gif|doc|docx)$/i',
            'file_type_end' => '/\.(.+$)/i',
            'upload_dir' => CHILD_CUSTOM_UPLOAD_DIR
        ];
    }
